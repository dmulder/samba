...
static PyObject* py_gpo_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
	...
	PyObject *c_obj;
	PyObject *talloc_obj;
	static char *kwlist[] = {"gpo_ptr", "talloc_ctx", NULL};
	self = (GPO*)type->tp_alloc(type, 0);
	if (PyArg_ParseTupleAndKeywords(args, kwds, "|OO", kwlist, &c_obj, &talloc_obj)) {
...
static PyGetSetDef GPO_setters[] = {
	{"ds_path", (getter)GPO_get_ds_path, NULL, "ds_path", NULL},
	{"file_sys_path", (getter)GPO_get_file_sys_path, NULL, "file_sys_path", NULL},
	{"display_name", (getter)GPO_get_display_name, NULL, "display_name", NULL},
	{"name", (getter)GPO_get_name, NULL, "name", NULL},
	{"link", (getter)GPO_get_link, NULL, "link", NULL},
	{"user_extensions", (getter)GPO_get_user_extensions, NULL, "user_extensions", NULL},
	{"machine_extensions", (getter)GPO_get_machine_extensions, NULL, "machine_extensions", NULL},
	{NULL}
};
...
static PyObject *py_gpo_get_unix_path(GPO *self, PyObject *args, PyObject *kwds)
{
	...
	static char *kwlist[] = {"cache_dir", NULL};
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s", kwlist, &cache_dir)) {
...
static int py_ads_init(ADS *self, PyObject *args, PyObject *kwds)
{
	...
	static char *kwlist[] = {"ldap_server", "loadparm_context", "credentials", NULL};
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "sO|O", kwlist, &ldap_server, &lp_obj, &creds))
		return -1;
	...
	if (lp_obj) lp_ctx = pytalloc_get_type(lp_obj, struct loadparm_context);
...
static PyObject *py_ads_get_gpo_list(ADS *self, PyObject *args, PyObject *kwds)
{
	...
	static char *kwlist[] = {"samaccountname", NULL};
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "s", kwlist, &samaccountname)) {
